...
# for rebuilding the model from checkpoint
...
if args.top_k:
    name_class = args.top_k
else:
    name_class = 1


probs, classes = predict (file_path, model, name_class, device)


class_names = [cat_to_name [item] for item in classes]

for l in range (name_class):
     print("Number: {}/{}.. ".format(l+1, name_class),
